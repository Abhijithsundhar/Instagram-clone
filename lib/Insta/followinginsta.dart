...
class FollowingInsta extends StatefulWidget {
  const FollowingInsta({super.key});

  @override
  State<FollowingInsta> createState() => _FollowingInstaState();
}

class _FollowingInstaState extends State<FollowingInsta> {
        ...
        child: Scaffold(
          appBar:PreferredSize(
            ...
            child: Row(children: [
              ...
              Text('Following',style: GoogleFonts.lobster(
                  fontSize: 25
              ),),
            ],),
          ),
